  ...
  const contactInfo = [
    {
      icon: Mail,
      label: 'Email',
      value: 'pateldivyad3233@gmail.com',
    ...
    },
    {
      icon: MapPin,
      label: 'Location',
      value: 'Vastral, Ahmedabad, Gujarat',
      href: '#'
    }
  ];
              ...
              <div className="space-y-6">
                {contactInfo.map((info, index) => (
                  <motion.a
                    key={info.label}
                    href={info.href}
                    className="flex items-center gap-4 p-4 bg-gradient-to-r from-blue-50 to-purple-50 rounded-2xl hover:shadow-md transition-all duration-300"
                ...
                <div className="flex gap-4">
                  {socialLinks.map((social, index) => (
                    <motion.a
                      ...
                      className={`w-12 h-12 bg-gray-100 rounded-2xl flex items-center justify-center text-gray-600 hover:text-white transition-all duration-300 ${social.color}`}
                      initial={{ opacity: 0, y: 20 }}
                      whileInView={{ opacity: 1, y: 0 }}
                      transition={{ duration: 0.5, delay: index * 0.1 }}
                      viewport={{ once: true }}
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-2xl font-semibold hover:shadow-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  {isSubmitting ? (
